...
void init_sensors() {
  ...
  hashmap_add(proto_sensors, "adxl", proto_sensor_create("adxl", 200, ADXL_ADDRESS, adxl_tar, adxl_betas));
  hashmap_add(proto_sensors, "ds32", proto_sensor_create("ds32",   1, DS32_ADDRESS, ds32_tar, NULL      ));
  hashmap_add(proto_sensors, "fram", proto_sensor_create("fram",   0, FRAM_ADDRESS, fram_tar, NULL      ));
  ...
  hashmap_add(proto_sensors, "ad15_gnd", proto_sensor_create("ad15_gnd", 0, AD15_GND, ad15_tar, gnd_betas));
  hashmap_add(proto_sensors, "ad15_vdd", proto_sensor_create("ad15_vdd", 0, AD15_VDD, ad15_tar, vdd_betas));
  hashmap_add(proto_sensors, "ad15_sda", proto_sensor_create("ad15_sda", 0, AD15_SDA, ad15_tar, sda_betas));
  hashmap_add(proto_sensors, "ad15_scl", proto_sensor_create("ad15_scl", 0, AD15_SCL, ad15_tar, scl_betas));
}
